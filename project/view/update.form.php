  ...
  <form action="../controller/update.control.php" method="post">
    <div class="mt-8 grid lg:grid-cols-2 gap-4">
      <div>
        ...
        <input type="text" name="image" id="name" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="URL" value="<?php echo $exe[0]['Pimage']?>" />
      </div>

      <div>
        <label for="email" class="text-sm text-gray-700 block mb-1 font-medium">Product name</label>
        <input type="text" name="name" id="email" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="product name" value="<?php echo $exe[0]['Pname']?>"/>
      </div>

      <div>
        <label for="job" class="text-sm text-gray-700 block mb-1 font-medium">Product price</label>
        <input type="text" name="price" id="job" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="product price $" value="<?php echo $exe[0]['Pprice']?>"/>
      </div>

      <div>
        <label for="brithday" class="text-sm text-gray-700 block mb-1 font-medium">Product category</label>
        <input type="text" name="category" id="brithday" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="exemple (Fragerance)" value="<?php echo $exe[0]['Pcategory']?>" />
      </div>
    </div>

    <div class="space-x-4 mt-8 flex justify-center">
        <input type="hidden" name="id" value="<?php echo $exe[0]['id']?>">
